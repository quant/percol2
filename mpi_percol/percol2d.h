...
public:
    ...
    virtual std::pair<int,int> ends(int i) const = 0;
    virtual MYARRAY<int> from(int v) const = 0;
    virtual MYARRAY<int> to(int v) const = 0;
    virtual std::pair<double,double> xy(int v) const = 0;
...
public:
    ...
    virtual std::pair<int,int> ends(int i) const;
    virtual MYARRAY<int> from(int v) const;
    virtual MYARRAY<int> to(int v) const;
    virtual std::pair<double,double> xy(int v) const;
